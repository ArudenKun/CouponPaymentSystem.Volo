    ...
    public class AbpMvcAuditFilter : IActionFilter, ITransientDependency
    {
        ...
        public void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            AbpAuditFilterData.Set(
                ...
                new AbpAuditFilterData(actionStopwatch, auditInfo)
            );
        }
        ...
        public void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            auditData.AuditInfo.ExecutionDuration = Convert.ToInt32(
                auditData.Stopwatch.Elapsed.TotalMilliseconds
            );
            ...
            if (_auditingConfiguration.SaveReturnValues && filterContext.Result != null)
            {
                switch (filterContext.Result)
                {
                    case AbpJsonResult abpJsonResult:
                        ...
                        {
                            auditData.AuditInfo.ReturnValue = _auditSerializer.Serialize(
                                ajaxResponse.Result
                            );
                        }
                        else
