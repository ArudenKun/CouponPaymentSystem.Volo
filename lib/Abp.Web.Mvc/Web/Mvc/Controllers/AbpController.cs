...
namespace Abp.Web.Mvc.Controllers
{
    ...
    public abstract class AbpController : Controller
    {
        ...
        protected ILocalizationSource LocalizationSource
        {
            get
            {
                ...
                if (
                    ...
                    || _localizationSource.Name != LocalizationSourceName
                )
                {
        ...
        )
        {
            if (
                Request.Url != null
                && AbpWebCommonModuleConfiguration.WrapResultFilters.HasFilterForWrapOnSuccess(
        ...
        private void SetCurrentMethodInfoAndWrapResultAttribute(
        ...
        protected override void OnException(ExceptionContext context)
        {
            void HandleError()
            {
                ...
                context.HttpContext.Response.StatusCode = GetStatusCodeForException(
                    context,
                    _wrapResultAttribute.WrapOnError
                );
            ...
            if (context.HttpContext.Request.Url != null)
            {
                ...
                if (
                    AbpWebCommonModuleConfiguration.WrapResultFilters.HasFilterForWrapOnError(
                        url,
                        out var wrapOnError
                    )
                )
