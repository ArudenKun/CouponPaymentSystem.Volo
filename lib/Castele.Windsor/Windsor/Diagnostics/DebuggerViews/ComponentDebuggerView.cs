...
namespace Castle.Windsor.Diagnostics.DebuggerViews
{
    ...
    public class ComponentDebuggerView
    {
        ...
        {
            var extensions = new List<IComponentDebuggerExtension>
            {
            ...
            return BuildRawFor(
                handler,
                description ?? handler.ComponentModel.GetLifestyleDescription(),
                extensions.ToArray()
            );
        }

        public static ComponentDebuggerView BuildRawFor(
            IHandler handler,
            string description,
        ...
        {
            return new ComponentDebuggerView(
                handler,
                description,
                new ComponentDebuggerExtension(items)
            );
        }
