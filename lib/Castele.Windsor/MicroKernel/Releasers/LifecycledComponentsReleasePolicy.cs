...
namespace Castle.MicroKernel.Releasers
{
    ...
    public class LifecycledComponentsReleasePolicy : IReleasePolicy
    {
        ...
        private readonly Dictionary<object, Burden> instance2Burden = new Dictionary<
            object,
            Burden
        ...
        public void Dispose()
        {
            ...
            foreach (var burden in Enumerable.Reverse(burdens))
            {
        ...
        public virtual void Track(object instance, Burden burden)
        {
            ...
            {
                var lifestyle =
                    ((object)burden.Model.CustomLifestyle) ?? burden.Model.LifestyleType;
        ...
        private void trackedComponentsDiagnostic_TrackedInstancesRequested(
            object sender,
            TrackedInstancesEventArgs e
        )
        {
        ...
        {
            var diagnosticsHost = (IDiagnosticsHost)
                kernel.GetSubSystem(SubSystemConstants.DiagnosticsKey);
