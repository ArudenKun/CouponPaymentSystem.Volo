...
namespace Castle.MicroKernel
{
    ...
    public partial class DefaultKernel
    {
        ...
        {
            return (T)
                (this as IKernelInternal).Resolve(
                    key,
                    typeof(T),
                    arguments: null,
        ...
        {
            return (TService[])
                (this as IKernelInternal).ResolveAll(typeof(TService), arguments, ReleasePolicy);
        }
        ...
        {
            return (TService[])
                (this as IKernelInternal).ResolveAll(typeof(TService), null, ReleasePolicy);
        }
        ...
        /// <returns></returns>
        object IKernelInternal.Resolve(
            string key,
            Type service,
            Arguments arguments,
