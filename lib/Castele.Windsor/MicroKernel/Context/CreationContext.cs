...
#pragma warning restore 612,618
        ...
        public Burden CreateBurden(IComponentActivator componentActivator, bool trackedExternally)
        {
            ...
            if (activator != null)
            {
                trackedExternally |= activator.IsManagedExternally(
        ...
        public ResolutionContext EnterResolutionContext(
            IHandler handlerBeingResolved,
        ...
        {
            return HasAdditionalArguments
                && (CanResolveByKey(dependency) || CanResolveByType(dependency));
        }
