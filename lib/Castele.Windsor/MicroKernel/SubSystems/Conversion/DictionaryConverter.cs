    ...
    public class DictionaryConverter : AbstractTypeConverter
    {
        ...
        public override object PerformConversion(IConfiguration configuration, Type targetType)
        {
            ...
            foreach (var itemConfig in configuration.Children)
            {
                ...
                {
                    convertKeyTo = Context.Composition.PerformConversion<Type>(
                ...
                {
                    convertValueTo = Context.Composition.PerformConversion<Type>(
                ...
                {
                    value = Context.Composition.PerformConversion(itemConfig, convertValueTo);
                }
                else
                {
