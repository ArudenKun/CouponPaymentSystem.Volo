...
namespace Castle.MicroKernel.Handlers
{
    ...
    public static class HandlerExtensionsUtil
    {
        ...
        public static ICollection<IReleaseExtension> ReleaseExtensions(
        ...
        )
        {
            ...
            var releaseExtensions =
                model.ExtendedProperties[ReleaseExtensionsKey] as ICollection<IReleaseExtension>;
        ...
        public static ICollection<IResolveExtension> ResolveExtensions(
            this ComponentModel model,
            bool ensureExists
        )
        {
            ...
            var resolveExtensions =
                model.ExtendedProperties[ResolveExtensionsKey] as ICollection<IResolveExtension>;
