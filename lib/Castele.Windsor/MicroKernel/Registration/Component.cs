...
namespace Castle.MicroKernel.Registration
{
    ...
    public static class Component
    {
        ...
        /// <returns>The component registration.</returns>
        public static ComponentRegistration<TService1> For<
            TService1,
            TService2,
            TService3,
            TService4
        >()
            where TService1 : class
        {
            return new ComponentRegistration<TService1>().Forward<
                TService2,
                TService3,
                TService4
            >();
        ...
        /// </example>
        public static Predicate<Type> HasAttribute<TAttribute>(Predicate<TAttribute> filter)
            where TAttribute : Attribute
        {
            return type =>
