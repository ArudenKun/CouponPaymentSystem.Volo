    ...
    public static class TypeUtil
    {
        ...
        public static Type TryMakeGenericType(this Type openGeneric, Type[] arguments)
        {
            ...
            catch (TypeLoadException e)
            {
                ...
                message.AppendLine(
                    "We were just about to make a generic version of "
                        + openGeneric.AssemblyQualifiedName
                ...
                {
                    message.AppendLine(
                        "Notice that some assemblies involved were coming from GAC."
                    );
                }
#endif
                message.AppendLine(
        ...
        private static void ToCSharpString(Type type, StringBuilder name, Type startType = null)
        {
            ...
            AppendGenericParameters(
                name,
                startType.GetGenericArguments(),
                skip: inheritedGenericArgs,
                take: ownGenericArgs
            );
        }
    }
