...
namespace Castle.Core
{
    ...
    public sealed class ComponentModel : GraphNode
    {
        ...
        private readonly ConstructorCandidateCollection constructors =
        ...
        public void AddService(Type type)
        {
            ...
            if (type.IsPrimitiveType())
            {
                throw new ArgumentException(
                    string.Format(
                        "Type {0} can not be used as a service. only classes, and interfaces can be exposed as a service.",
                        type
                    )
                );
            }
        ...
        public override string ToString()
        {
            ...
            else
            {
                value = string.Format(
                    "{0} / {1}",
                    Implementation.ToCSharpString(),
                    services[0].ToCSharpString()
                );
            }
