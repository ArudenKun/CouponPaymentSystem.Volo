...
public class AbpMemoryCache : CacheBase
{
        ...
        : base(name)
    {
        ...
        _memoryCache = new MemoryCache(
            new OptionsWrapper<MemoryCacheOptions>(memoryCacheOptions ?? new MemoryCacheOptions())
        );
    }
    ...
    public override void Clear()
    {
        ...
        _memoryCache = new MemoryCache(
            new OptionsWrapper<MemoryCacheOptions>(_memoryCacheOptions ?? new MemoryCacheOptions())
        );
    }
