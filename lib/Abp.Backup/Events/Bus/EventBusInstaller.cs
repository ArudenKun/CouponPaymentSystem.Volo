...
/// </summary>
internal class EventBusInstaller : IInstaller
{
    ...
    public void Install(IStashboxContainer container)
    {
        ...
        {
            container.Register<IEventBus>(c =>
                c.WithInstance(EventBus.Default).WithSingletonLifetime()
            );
        }
        else
        {
        ...
        container.registrator.Kernel.ComponentRegistered += Kernel_ComponentRegistered;
    }
