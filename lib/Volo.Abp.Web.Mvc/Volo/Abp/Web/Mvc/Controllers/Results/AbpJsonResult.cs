...
namespace Volo.Abp.Web.Mvc.Controllers.Results;
...
public class AbpJsonResult : JsonResult
{
    ...
    public required IJsonSerializer JsonSerializer { get; init; }
    ...
    public override void ExecuteResult(ControllerContext context)
    {
        ...
        {
            ignoreJsonRequestBehaviorDenyGet = string.Equals(
                context.HttpContext.Items["IgnoreJsonRequestBehaviorDenyGet"].ToString(),
                "true",
        ...
        if (Data != null)
        {
            response.Write(JsonSerializer.Serialize(Data, CamelCase, Indented));
        }
    }
}
