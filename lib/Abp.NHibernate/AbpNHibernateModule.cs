...
public class AbpNHibernateModule : AbpModule
{
    ...
    public override void PreInitialize()
    {
        ...
        Configuration.ReplaceService<IUnitOfWorkFilterExecuter, NhUnitOfWorkFilterExecuter>(
    ...
    public override void Initialize()
    {
        ...
        _sessionFactory = Configuration
            ...
            .FluentConfiguration.Mappings(m => m.FluentMappings.Add(typeof(SoftDeleteFilter)))
            ...
            .ExposeConfiguration(config =>
            {
                config.SetListener(
                    ListenerType.Delete,
                    IocManager.Resolve<AbpNHibernateDeleteEventListener>()
                );
                config.SetListener(
                    ListenerType.Load,
                    IocManager.Resolve<AbpNHibernateLoadEventListener>()
                );
