...
internal class NhActiveTransactionProvider : IActiveTransactionProvider, ITransientDependency
{
    ...
    public Task<IDbTransaction> GetActiveTransactionAsync(ActiveTransactionProviderArgs args)
    {
        ...
        var dbTransaction = GetFieldValue(typeof(AdoTransaction), adoTransaction, "trans")
            .As<IDbTransaction>();
