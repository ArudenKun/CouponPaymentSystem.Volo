...
public abstract class EntityMap<TEntity, TPrimaryKey> : ClassMap<TEntity>
    where TEntity : IEntity<TPrimaryKey>
{
    ...
    protected new OneToManyPart<TChild> HasMany<TChild>(
        Expression<Func<TEntity, IEnumerable<TChild>>> memberExpression
    )
    {
    ...
    protected new OneToManyPart<TChild> HasMany<TKey, TChild>(
        Expression<Func<TEntity, IDictionary<TKey, TChild>>> memberExpression
    )
    {
    ...
    protected new ManyToManyPart<TChild> HasManyToMany<TChild>(
        Expression<Func<TEntity, IEnumerable<TChild>>> memberExpression
    )
    {
