...
public static class NhMappingExtensions
{
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public static void MapAudited<TEntity>(this ClassMap<TEntity> mapping)
        where TEntity : IAudited
    {
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public static void MapCreationAudited<TEntity>(this ClassMap<TEntity> mapping)
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public static void MapDeletionAudited<TEntity>(this ClassMap<TEntity> mapping)
        where TEntity : IDeletionAudited
    {
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public static void MapIsDeleted<TEntity>(this ClassMap<TEntity> mapping)
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public static void MapIsActive<TEntity>(this ClassMap<TEntity> mapping)
        where TEntity : IPassivable
    {
