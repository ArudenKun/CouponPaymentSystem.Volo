...
namespace Castle.MicroKernel.Registration
{
    ...
    public sealed class Dependency
    {
        ...
        /// </summary>
        public static ServiceOverride OnComponentCollection(
            string collectionDependencyName,
        ...
        internal bool Accept<TItem>(ICollection<TItem> items)
            where TItem : class
        {
        ...
        {
            var resourceManagerProperty = typeof(TResources).GetProperty(
                "ResourceManager",
            ...
            catch (Exception e)
            {
                throw new ArgumentException(
                    string.Format(
                        "Could not read property {1} on type {0}",
                        typeof(TResources),
        ...
        public static Property OnResource(
