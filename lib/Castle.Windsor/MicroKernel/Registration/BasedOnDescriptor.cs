...
namespace Castle.MicroKernel.Registration
{
    ...
    public class BasedOnDescriptor : IRegistration
    {
        ...
        /// </summary>
        internal BasedOnDescriptor(
            IEnumerable<Type> basedOn,
            FromDescriptor from,
            Predicate<Type> additionalFilters
        )
        {
        ...
        /// <param name = "configurer"> The configuration action. </param>
        /// <returns> </returns>
        public BasedOnDescriptor ConfigureFor<TComponentImplementationType>(
            Action<ComponentRegistration> configurer
        )
        {
            return ConfigureIf(
                r => typeof(TComponentImplementationType).IsAssignableFrom(r.Implementation),
                configurer
            );
        }
        ...
        /// <returns> </returns>
        public BasedOnDescriptor ConfigureIf(
            Predicate<ComponentRegistration> condition,
            Action<ComponentRegistration> configurer
        )
        {
            configuration += r =>
        ...
        /// </summary>
        /// <returns> </returns>
        public BasedOnDescriptor LifestyleCustom<TLifestyleManager>()
        ...
        /// </summary>
        /// <returns> </returns>
        public BasedOnDescriptor LifestyleScoped<TScopeAccessor>()
        ...
        /// </summary>
        /// <returns> </returns>
        public BasedOnDescriptor LifestyleBoundToNearest<TBaseForRoot>()
            where TBaseForRoot : class
        {
