...
namespace Castle.MicroKernel
{
    ...
    /// </summary>
    public sealed class Arguments : IEnumerable<KeyValuePair<object, object>> // Required for collection initializers
    {
        ...
        private void CheckKeyType(object key)
        {
            if (!(key is string) && !(key is Type))
            {
                throw new ArgumentException(
                    $"The argument '{key}' should be of type string or System.Type."
                );
            }
        }
