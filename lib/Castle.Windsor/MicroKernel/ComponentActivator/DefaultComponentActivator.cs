...
namespace Castle.MicroKernel.ComponentActivator
{
    ...
    public class DefaultComponentActivator : AbstractComponentActivator
    {
        ...
        {
#if FEATURE_REMOTING
            useFastCreateInstance =
                !model.Implementation.IsContextful
        ...
        )
        {
            ...
            if (createProxy)
            {
                try
                {
                    instance = Kernel.ProxyFactory.Create(
                        Kernel,
                        instance,
                        Model,
                        context,
                ...
                catch (Exception ex)
                {
                    ...
                    throw new ComponentActivatorException(
                        "ComponentActivator: could not proxy " + Model.Implementation.FullName,
                        ex,
                        Model
                    );
                }
        ...
        protected object CreateInstanceCore(
            ConstructorCandidate constructor,
            object[] arguments,
            Type implType
        )
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ComponentActivatorException(
                    "ComponentActivator: could not instantiate " + Model.Implementation.FullName,
                    ex,
                    Model
                );
            }
        ...
        private object FastCreateInstance(
            Type implType,
            object[] arguments,
            ConstructorCandidate constructor
        )
        ...
        private static bool BestScoreSoFar(
            int candidatePoints,
            int winnerPoints,
            ConstructorCandidate winnerCandidate
        )
        {
        ...
        private bool CheckCtorCandidate(
            ConstructorCandidate candidate,
            CreationContext context,
            out int candidatePoints
        )
        {
            candidatePoints = 0;
        ...
        protected virtual bool CanSatisfyDependency(
            CreationContext context,
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    arguments[i] = Kernel.Resolver.Resolve(
                        context,
                        context.Handler,
                        Model,
                        constructor.Dependencies[i]
                    );
                }
                return arguments;
            }
        ...
        private object ObtainPropertyValue(
            CreationContext context,
        ...
        )
        {
            ...
            )
            {
                ...
                catch (Exception e)
                {
                    ...
                    Kernel.Logger.LogWarning(
                        string.Format(
                            "Exception when resolving optional dependency {0} on component {1}.",
                            property.Dependency,
                            Model.Name
                        ),
                        e
