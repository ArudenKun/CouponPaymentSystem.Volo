...
namespace Castle.MicroKernel.ModelBuilder.Inspectors
{
    ...
    public class ComponentProxyInspector : IContributeComponentModelConstruction
    {
        ...
        protected virtual ComponentProxyBehaviorAttribute ReadProxyBehaviorFromType(
            Type implementation
        )
        {
            return implementation
                .GetAttributes<ComponentProxyBehaviorAttribute>(true)
                .FirstOrDefault();
        }
        ...
        private void ReadProxyBehaviorFromConfig(
            ComponentModel model,
            ComponentProxyBehaviorAttribute behavior
        )
        {
            ...
            if (mbrProxy != null)
            {
                behavior.UseMarshalByRefProxy = converter
                    .PerformConversion<bool?>(mbrProxy)
        ...
        private static void ApplyProxyBehavior(
            ComponentProxyBehaviorAttribute behavior,
            ComponentModel model
        )
        {
