...
namespace Castle.Windsor.Proxy
{
    ...
    public class DefaultProxyFactory : AbstractProxyFactory, IDeserializationCallback
    {
        ...
        public override object Create(
            IProxyFactoryExtension customFactory,
            IKernel kernel,
        ...
        )
        {
            ...
            var proxyGenOptions = CreateProxyGenerationOptionsFrom(
                proxyOptions,
                kernel,
                context,
                model
            ...
            var proxy = customFactory.Generate(
                builder,
                proxyGenOptions,
                interceptors,
                model,
        ...
        )
        {
            ...
            else
            {
                ...
                if (
                    ...
                    && model.Implementation != typeof(LateBoundComponent)
                )
                {
                ...
                var additionalInterfaces = model
                    .Services.SkipWhile(s => s.GetTypeInfo().IsClass)
                    .Concat(interfaces)
                    .ToArray();
        ...
        protected static ProxyGenerationOptions CreateProxyGenerationOptionsFrom(
        ...
        protected virtual void CustomizeProxy(
            object proxy,
        ...
        protected virtual void CustomizeOptions(
            ProxyGenerationOptions options,
            IKernel kernel,
            ComponentModel model,
            object[] arguments
        ...
        public override bool RequiresTargetInstance(IKernel kernel, ComponentModel model)
        {
            ...
            return model.HasClassServices == false && proxyOptions.OmitTarget == false;
        }
