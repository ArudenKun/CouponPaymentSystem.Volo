...
namespace Castle.Windsor.Installer
{
    ...
    public class FromAssembly
    {
        ...
        /// <returns> </returns>
        public static IWindsorInstaller InDirectory(
        ...
        /// </summary>
        /// <returns> </returns>
        public static IWindsorInstaller Instance(
            Assembly assembly,
            InstallerFactory installerFactory
        )
        {
        ...
        /// </summary>
        /// <returns> </returns>
        public static IWindsorInstaller Named(
            string assemblyName,
            InstallerFactory installerFactory
        )
        {
        ...
        private static IWindsorInstaller ApplicationAssemblies(
            Assembly rootAssembly,
            InstallerFactory installerFactory
        )
        {
            var assemblies = new HashSet<Assembly>(
                ReflectionUtil.GetApplicationAssemblies(rootAssembly)
            );
            var installer = new CompositeInstaller();
            foreach (var assembly in assemblies)
            {
