...
namespace Castle.Windsor.Configuration.Interpreters
{
    ...
    public abstract class AbstractInterpreter : IConfigurationInterpreter
    {
        ...
        protected static void AddChildContainerConfig(
            string name,
        ...
        protected static void AddFacilityConfig(
            string id,
        ...
        protected static void AddComponentConfig(
            string id,
        ...
        protected static void AddInstallerConfig(
        ...
        private static void AssertValidId(string id)
        {
            if (string.IsNullOrEmpty(id))
            {
                const string message =
                    "Component or Facility was declared without a proper 'id' or 'type' attribute.";
