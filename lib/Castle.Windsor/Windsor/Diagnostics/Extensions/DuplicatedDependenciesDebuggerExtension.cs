...
namespace Castle.Windsor.Diagnostics.Extensions
{
    ...
    public class DuplicatedDependenciesDebuggerExtension : AbstractContainerDebuggerExtension
    {
        ...
        private ComponentDebuggerView ComponentWithDuplicateDependenciesView(
        ...
        )
        {
            ...
            return ComponentDebuggerView.BuildRawFor(
                handler,
        ...
        private DebuggerViewItemWithDetails MismatchView(DependencyDuplicate input)
        {
            return new DebuggerViewItemWithDetails(
                Description(input.Dependency1),
                Description(input.Dependency2),
                diagnostic.GetDetails(input)
            );
        }
        ...
        {
            return dependencyModel.TargetItemType.ToCSharpString()
                + " "
                + dependencyModel.DependencyKey;
        }
    }
}
