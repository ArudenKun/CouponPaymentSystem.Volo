...
namespace Castle.Windsor.Diagnostics
{
    ...
    public class PotentialLifestyleMismatchesDiagnostic : IPotentialLifestyleMismatchesDiagnostic
    {
        ...
        private IEnumerable<MismatchedLifestyleDependency> GetMismatch(
            MismatchedLifestyleDependency parent,
        ...
        private class MismatchedLifestyleDependency
        {
            ...
            public MismatchedLifestyleDependency(
                IHandler handler,
                MismatchedLifestyleDependency parent = null
            )
            {
                Handler = handler;
                Parent = parent;
