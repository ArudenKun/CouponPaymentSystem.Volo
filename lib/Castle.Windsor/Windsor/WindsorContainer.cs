...
namespace Castle.Windsor
{
        ...
        IWindsorContainer
    {
        ...
        private readonly Dictionary<string, IWindsorContainer> childContainers = new Dictionary<
            string,
            IWindsorContainer
        ...
        /// <returns></returns>
        public IWindsorContainer AddFacility<T>()
        ...
        private XmlInterpreter GetInterpreter(string configurationUri)
        {
            try
            {
                var resources = (IResourceSubSystem)
