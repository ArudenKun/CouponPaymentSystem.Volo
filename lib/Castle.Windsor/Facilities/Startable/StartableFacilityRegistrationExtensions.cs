...
namespace Castle.Facilities.Startable
{
    ...
    {
        public static ComponentRegistration<TService> Start<TService>(
        ...
        public static ComponentRegistration<TService> StartUsingMethod<TService>(
            ...
            where TService : class
        {
            return Start(registration).AddAttributeDescriptor("startMethod", startMethod);
        }
        ...
        public static ComponentRegistration<TService> StopUsingMethod<TService>(
            ...
            where TService : class
        {
            return Start(registration).AddAttributeDescriptor("stopMethod", stopMethod);
        }
        ...
        private static TExpression EnsureIs<TExpression>(Expression expression)
        ...
        private static string ObtainMethodName<TService>(
            Expression<Func<TService, Action>> methodToUse
        )
        {
