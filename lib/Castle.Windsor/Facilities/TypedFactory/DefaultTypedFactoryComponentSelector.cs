...
namespace Castle.Facilities.TypedFactory
{
    ...
    public class DefaultTypedFactoryComponentSelector : ITypedFactoryComponentSelector
    {
        ...
        public DefaultTypedFactoryComponentSelector(
        ...
        public Func<IKernelInternal, IReleasePolicy, object> SelectComponent(
            MethodInfo method,
            Type type,
            object[] arguments
        )
        ...
        /// <returns></returns>
        protected virtual Func<IKernelInternal, IReleasePolicy, object> BuildFactoryComponent(
            MethodInfo method,
        ...
        )
        {
            ...
            if (itemType == null)
            {
                return new TypedFactoryComponentResolver(
                    componentName,
                    componentType,
                    additionalArguments,
