...
namespace Castle.Core
{
    ...
    public class StandardPropertyFilters
    {
        ...
        public static PropertySet[] Default(
        ...
        public static PropertyDependencyFilter FromObsoleteFunction(
            Func<ComponentModel, PropertyInfo, bool> filter,
            bool isRequired
        )
        {
        ...
        public static ICollection<PropertyDependencyFilter> GetPropertyFilters(
            ComponentModel componentModel,
            bool createIfMissing
        )
        {
            var filters =
                (ICollection<PropertyDependencyFilter>)
                    componentModel.ExtendedProperties[Constants.PropertyFilters];
        ...
        public static PropertySet[] IgnoreAll(
            ComponentModel model,
            ICollection<PropertyInfo> properties,
            PropertySetBuilder propertySetBuilder
        )
        ...
        public static PropertySet[] IgnoreBase(
            ComponentModel model,
            ICollection<PropertyInfo> properties,
            PropertySetBuilder propertySetBuilder
        )
        {
            var baseProperties = properties
                .Where(p => p.DeclaringType != model.Implementation)
                .ToArray();
        ...
        public static PropertyDependencyFilter IgnoreSelected(
            Func<ComponentModel, PropertyInfo, bool> selector
        )
        {
            return (model, properties, callback) =>
            {
        ...
        public static PropertySet[] RequireAll(
            ComponentModel model,
            ICollection<PropertyInfo> properties,
            PropertySetBuilder propertySetBuilder
        )
        ...
        public static PropertySet[] RequireBase(
            ComponentModel model,
            ICollection<PropertyInfo> properties,
            PropertySetBuilder propertySetBuilder
        )
        ...
        public static PropertyDependencyFilter RequireSelected(
            Func<ComponentModel, PropertyInfo, bool> selector
        )
        {
            return (model, properties, callback) =>
                properties
                    .ToArray()
                    .Where(property => selector(model, property))
                    .Select(p =>
                    {
                        properties.Remove(p);
