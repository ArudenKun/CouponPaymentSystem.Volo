...
namespace Castle.Core
{
    ...
    public class DependencyModel
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return other.targetType == targetType && Equals(other.DependencyKey, DependencyKey);
        }
        ...
        public virtual void Init(ParameterModelCollection parameters)
        {
            ...
            Parameter =
                ObtainParameterModelByName(parameters) ?? ObtainParameterModelByType(parameters);
        }
        ...
        private ParameterModel GetParameterModelByType(
            Type type,
            ParameterModelCollection parameters
        )
        {
