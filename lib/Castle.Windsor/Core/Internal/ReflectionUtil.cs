...
namespace Castle.Core.Internal
{
    ...
    {
        public static readonly Type[] OpenGenericArrayInterfaces = typeof(object[])
            .GetInterfaces()
        ...
        private static readonly ConcurrentDictionary<
            ConstructorInfo,
            Func<object[], object>
        > factories = new ConcurrentDictionary<ConstructorInfo, Func<object[], object>>();

        public static TBase CreateInstance<TBase>(
            this Type subtypeofTBase,
        ...
        public static Assembly GetAssemblyNamed(
            string filePath,
            Predicate<AssemblyName> nameFilter,
        ...
        public static Type[] GetAvailableTypesOrdered(
            this Assembly assembly,
            bool includeNonExported = false
        )
        {
            return assembly
                .GetAvailableTypes(includeNonExported)
        ...
        internal static TAttribute[] GetAttributes<TAttribute>(this Type item, bool inherit)
            where TAttribute : Attribute
        {
            return (TAttribute[])
                item.GetTypeInfo().GetCustomAttributes(typeof(TAttribute), inherit);
        }
        ...
        public static Type GetCompatibleArrayItemType(this Type type)
        {
            ...
            if (
                type.GetTypeInfo().IsGenericType == false
        ...
        private static void EnsureIsAssignable<TBase>(Type subtypeofTBase)
        {
            ...
            if (typeof(TBase).GetTypeInfo().IsInterface)
            {
                message = String.Format(
                    "Type {0} does not implement the interface {1}.",
            ...
            {
                message = String.Format(
                    "Type {0} does not inherit from {1}.",
                    subtypeofTBase.FullName,
                    typeof(TBase).FullName
                );
            }
        ...
        private static TBase Instantiate<TBase>(Type subtypeofTBase, object[] ctorArgs)
        {
            ...
            var constructor = subtypeofTBase.GetConstructor(
        ...
        private static void AddApplicationAssemblies(
            Assembly assembly,
