...
{
    public static readonly XmlTypeSerializer ForBoolean = new XmlSimpleSerializer<Boolean>(
            XmlConvert.ToString,
        ...
        ForDateTimeOffset = new XmlSimpleSerializer<DateTimeOffset>(
            XmlConvert.ToString,
            XmlConvert.ToDateTimeOffset
        ),
        ForGuid = new XmlSimpleSerializer<Guid>(XmlConvert.ToString, XmlConvert.ToGuid),
        ForByteArray = new XmlSimpleSerializer<Byte[]>(
            Convert.ToBase64String,
            Convert.FromBase64String
        ),
        ForUri = new XmlSimpleSerializer<Uri>(
            u => u.ToString(),
