...
{
    private static readonly Dictionary<Type, MethodInfo[]> instanceMethodsCache =
        new Dictionary<Type, MethodInfo[]>();
    private static readonly Dictionary<Type, bool> hasAnyOverridableDefaultImplementationsCache =
