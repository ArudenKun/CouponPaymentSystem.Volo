...
namespace Castle.DynamicProxy
{
    ...
    public class ModuleScope
    {
        ...
        private readonly SynchronizedDictionary<CacheKey, Type> typeCache =
            new SynchronizedDictionary<CacheKey, Type>();
            ...
            if (savePhysicalAssembly)
            {
                ...
                catch (ArgumentException e)
                {
                    if (
                        ...
                        && e.StackTrace.Contains("ComputePublicKey") == false
                    )
                    {
        ...
        public string? SaveAssembly(bool strongNamed)
        {
            ...
            if (strongNamed)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "No strong-named assembly has been generated."
                    );
                }
            ...
            else
            {
                ...
                {
                    throw new InvalidOperationException(
                        "No weak-named assembly has been generated."
                    );
                }
        ...
        internal TypeBuilder DefineType(
            bool inSignedModulePreferably,
            string name,
            TypeAttributes flags
        )
        {
            var module = ObtainDynamicModule(
                disableSignedModule == false && inSignedModulePreferably
            );
