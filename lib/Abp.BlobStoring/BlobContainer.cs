    ...
    where TContainer : class
{
    ...
    {
        return Container.SaveAsync(name, stream, overrideExisting, cancellationToken);
    }
    ...
    {
        return Container.DeleteAsync(name, cancellationToken);
    }
    ...
    {
        return Container.ExistsAsync(name, cancellationToken);
    }

    public virtual Task<Stream> GetAsync(string name, CancellationToken cancellationToken = default)
    {
        return Container.GetAsync(name, cancellationToken);
    }
    ...
    {
        return Container.GetOrNullAsync(name, cancellationToken);
    }
}
