...
namespace Abp.Notifications
{
    ...
    public class UserNotificationManager : IUserNotificationManager, ISingletonDependency
    {
        ...
        {
            var userNotifications = await _store.GetUserNotificationsWithNotificationsAsync(
                user,
                state,
                skipCount,
                maxResultCount,
        ...
        {
            var userNotifications = _store.GetUserNotificationsWithNotifications(
                user,
                state,
                skipCount,
                maxResultCount,
        ...
        public async Task<UserNotification> GetUserNotificationAsync(
            int? tenantId,
            Guid userNotificationId
        )
        {
            var userNotification = await _store.GetUserNotificationWithNotificationOrNullAsync(
                tenantId,
                userNotificationId
            );
        ...
        {
            var userNotification = _store.GetUserNotificationWithNotificationOrNull(
                tenantId,
                userNotificationId
            );
            if (userNotification == null)
        ...
        public void UpdateUserNotificationState(
            int? tenantId,
            Guid userNotificationId,
            UserNotificationState state
        )
        ...
        public void UpdateAllUserNotificationStates(
            UserIdentifier user,
            UserNotificationState state
        )
        {
