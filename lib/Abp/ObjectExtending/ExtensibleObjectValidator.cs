...
public static class ExtensibleObjectValidator
{
    ...
    {
        return GetValidationErrors(extensibleObject, objectValidationContext).Any();
    }
    ...
    {
        return GetValidationErrors(extensibleObject, propertyName, value, objectValidationContext)
            .Any();
    }
    ...
    )
    {
        ...
        var objectExtensionInfo = ObjectExtensionManager.Instance.GetOrNull(objectType);
    ...
    )
    {
        ...
        {
            var result = attribute.GetValidationResult(value, propertyValidationContext);
