...
public class IocManager : IIocManager
{
    ...
    public IEnumerator<ServiceDescriptor> GetEnumerator() => throw new NotSupportedException();

    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

    public void Add(ServiceDescriptor item)
    {
        IocContainer.AddServiceDescriptor(item);
    }
    ...
    {
        return IocContainer.Resolve(serviceType);
    }
}
