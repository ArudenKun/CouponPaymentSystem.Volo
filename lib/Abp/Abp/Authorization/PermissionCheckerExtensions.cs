...
public static class PermissionCheckerExtensions
{
    ...
    public static async Task<bool> IsGrantedAsync(
        this IPermissionChecker permissionChecker,
        UserIdentifier user,
        bool requiresAll,
    ...
    {
        if (permissionChecker is not IServiceProviderAccessor serviceProviderAccessor)
        {
            return defaultValue;
        }
        ...
        return permissionNames
            .Select(permissionName =>
            {
                ...
                return permission?.DisplayName == null
                    ? permissionName
                    : permission.DisplayName.Localize(localizationContext);
            })
            .ToArray();
    }
}
