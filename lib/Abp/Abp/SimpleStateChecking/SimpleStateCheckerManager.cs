    ...
    where TState : IHasSimpleStateCheckers<TState>
{
    ...
    public SimpleStateCheckerManager(
        ...
        IOptions<AbpSimpleStateCheckerOptions<TState>> options
    )
    {
    ...
    public virtual async Task<SimpleStateCheckerResult<TState>> IsEnabledAsync(TState[] states)
    {
        ...
        using (var scope = ServiceProvider.CreateScope())
        {
            ...
            foreach (
                ISimpleBatchStateChecker<TState> globalStateChecker in Options
    ...
    protected virtual async Task<bool> InternalIsEnabledAsync(TState state, bool useBatchChecker)
    {
        using (var scope = ServiceProvider.CreateScope())
        {
            ...
            foreach (
                ISimpleStateChecker<TState> provider in Options
