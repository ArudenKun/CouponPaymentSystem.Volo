    ...
    where TEntity : class, IEntity<TPrimaryKey>
{
    ...
    public required IUnitOfWorkManager UnitOfWorkManager { get; init; }
    public required IServiceProvider IocResolver { get; init; }
    public required ICancellationTokenProvider CancellationTokenProvider { get; init; }
