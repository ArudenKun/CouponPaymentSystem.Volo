...
//     {
//         registrationBuilder = registrationBuilder.InvokeActivatedActions(
//             activatedActionList,
//             serviceDescriptor
//         );
//
...
//         TActivatorData,
//         TRegistrationStyle
//     > InvokeActivatedActions<TLimit, TActivatorData, TRegistrationStyle>(
//         this IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> registrationBuilder,
//         ServiceActivatedActionList activatedActionList,
//         ServiceDescriptor serviceDescriptor
//     )
...
//         where TActivatorData : ReflectionActivatorData
//     {
//         var serviceRegistredArgs = new OnServiceRegisteredContext(
//             serviceType,
//             implementationType,
//             serviceKey
//         );
...
//                 serviceRegistredArgs.ImplementationType.GetCustomAttribute<DisableAbpFeaturesAttribute>(
//                     true
//                 );
//             if (
//                 disableAbpFeaturesAttribute == null
//                 || !disableAbpFeaturesAttribute.DisableInterceptors
//             )
//             {
