...
{
    public static async Task AwaitTaskWithFinally(
    ...
    public static async Task<T> AwaitTaskWithFinallyAndGetResult<T>(
    ...
    public static object CallAwaitTaskWithFinallyAndGetResult(
        Type taskReturnType,
    ...
    )
    {
        var returnFunc = typeof(InternalAsyncHelper)
            .GetTypeInfo()
            .GetMethod(
                "ConvertFuncOfObjectToFuncOfTask",
