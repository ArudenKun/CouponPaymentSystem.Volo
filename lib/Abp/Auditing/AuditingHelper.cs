    ...
    public class AuditingHelper : IAuditingHelper, ITransientDependency
    {
        ...
        )
        {
            var auditInfo = new AuditInfo
            {
                ...
                ServiceName = (type != null ? type.FullName : string.Empty) ?? string.Empty,
            ...
            {
                Logger.LogWarning(ex, "Failed to create audit info");
            }
        ...
        private string ConvertArgumentsToJson(IDictionary<string, object> arguments)
        {
            ...
            {
                Logger.LogWarning(ex, "Failed to convert arguments to json");
                return "{}";
            }
        }
