...
public class ClaimsAbpSession : AbpSessionBase, ISingletonDependency
{
    ...
    public override long? ImpersonatorUserId
    {
        get
        {
            var impersonatorUserIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c =>
    ...
    public override int? ImpersonatorTenantId
    {
        get
        {
            ...
            var impersonatorTenantIdClaim = PrincipalAccessor.Principal?.Claims.FirstOrDefault(c =>
