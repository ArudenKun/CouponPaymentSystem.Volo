...
namespace Abp
{
    ...
    public class AbpBootstrapper : IDisposable
    {
        ...
        )
        {
            ...
            if (!typeof(AbpModule).GetTypeInfo().IsAssignableFrom(startupModule))
            {
                throw new ArgumentException(
                    $"{nameof(startupModule)} should be derived from {nameof(AbpModule)}."
                );
            }
        ...
        public virtual void Initialize()
        {
            ...
            {
                _logger.LogCritical(ex, "A critical error occured in the bootstraper");
                throw;
            }
        }
        ...
        private void ResolveLogger()
        {
            ...
            {
                _logger = IocManager.Resolve<ILoggerFactory>().CreateLogger<AbpBootstrapper>();
            }
        }
        ...
        private void RegisterBootstrapper()
        {
            ...
            {
                IocManager.IocContainer.Register(Component.For<AbpBootstrapper>().Instance(this));
            }
        }
