...
public static class DynamicEntityPropertyValueManagerExtensions
{
    public static List<DynamicEntityPropertyValue> GetValues<TEntity, TPrimaryKey>(
        this IDynamicEntityPropertyValueManager manager,
        string entityId
    )
    ...
    public static List<DynamicEntityPropertyValue> GetValues<TEntity>(
        ...
        where TEntity : IEntity<int>
    {
        return manager.GetValues<TEntity, int>(
            entityId: entityId,
            dynamicPropertyId: dynamicPropertyId
        );
    }
    ...
    public static Task<List<DynamicEntityPropertyValue>> GetValuesAsync<TEntity>(
        ...
        where TEntity : IEntity<int>
    {
        return manager.GetValuesAsync<TEntity, int>(
            entityId: entityId,
            dynamicPropertyId: dynamicPropertyId
        );
    }
    ...
    public static List<DynamicEntityPropertyValue> GetValues<TEntity, TPrimaryKey>(
        ...
        where TEntity : IEntity<TPrimaryKey>
    {
        return manager.GetValues<TEntity, TPrimaryKey>(
            entityId: entityId,
    ...
    public static List<DynamicEntityPropertyValue> GetValues<TEntity>(
        ...
        where TEntity : IEntity<int>
    {
        return manager.GetValues<TEntity>(
            entityId: entityId,
            dynamicPropertyId: dynamicProperty.Id
        );
    }
    ...
    public static Task<List<DynamicEntityPropertyValue>> GetValuesAsync<TEntity, TPrimaryKey>(
        ...
        where TEntity : IEntity<TPrimaryKey>
    {
        return manager.GetValuesAsync<TEntity, TPrimaryKey>(
            entityId: entityId,
            dynamicPropertyId: dynamicProperty.Id
        );
    }
    ...
    public static Task<List<DynamicEntityPropertyValue>> GetValuesAsync<TEntity>(
        ...
        where TEntity : IEntity<int>
    {
        return manager.GetValuesAsync<TEntity>(
            entityId: entityId,
            dynamicPropertyId: dynamicProperty.Id
        );
    }
