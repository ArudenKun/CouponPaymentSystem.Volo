...
public static class DynamicEntityPropertyManagerExtensions
{
    ...
    public static List<DynamicEntityProperty> GetAll<TEntity>(
        this IDynamicEntityPropertyManager manager
    )
    ...
    public static Task<List<DynamicEntityProperty>> GetAllAsync<TEntity>(
        this IDynamicEntityPropertyManager manager
    )
        where TEntity : IEntity<int>
    {
    ...
    public static DynamicEntityProperty Add<TEntity>(
        this IDynamicEntityPropertyManager manager,
    ...
    public static DynamicEntityProperty Add<TEntity, TPrimaryKey>(
        this IDynamicEntityPropertyManager manager,
        int dynamicPropertyId,
        int? tenantId
    )
    ...
    public static Task<DynamicEntityProperty> AddAsync<TEntity>(
        this IDynamicEntityPropertyManager manager,
        int dynamicPropertyId,
        int? tenantId
    )
