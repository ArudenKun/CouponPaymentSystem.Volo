...
namespace Abp.Webhooks
{
    public class WebhookManager : DomainService, IWebhookManager
    {
        ...
        public virtual async Task<WebhookPayload> GetWebhookPayloadAsync(
            ...
            var data =
                _webhooksConfiguration.JsonSerializerOptions != null
                    ? webhookSenderArgs.Data.FromJsonString<dynamic>(
                        _webhooksConfiguration.JsonSerializerOptions
                    )
                    : webhookSenderArgs.Data.FromJsonString<dynamic>();
        ...
        public virtual WebhookPayload GetWebhookPayload(WebhookSenderArgs webhookSenderArgs)
        {
            ...
            var attemptNumber =
                _webhookSendAttemptStore.GetSendAttemptCount(
                    webhookSenderArgs.TenantId,
                    webhookSenderArgs.WebhookEventId,
                    webhookSenderArgs.WebhookSubscriptionId
                ) + 1;
        ...
        public virtual void SignWebhookRequest(
        ...
        public virtual async Task<string> GetSerializedBodyAsync(
            WebhookSenderArgs webhookSenderArgs
        )
        {
            if (webhookSenderArgs.SendExactSameData)
        ...
        public virtual async Task<Guid> InsertAndGetIdWebhookSendAttemptAsync(
            WebhookSenderArgs webhookSenderArgs
        )
        {
        ...
        public virtual async Task StoreResponseOnWebhookSendAttemptAsync(
        ...
        )
        {
            using (var uow = UnitOfWorkManager.Begin())
            {
                var webhookSendAttempt = await _webhookSendAttemptStore.GetAsync(
                    tenantId,
