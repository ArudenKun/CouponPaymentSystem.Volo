...
namespace Abp.Webhooks
{
    public static class WebhookSubscriptionInfoExtensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<string> GetSubscribedWebhooks(
            this WebhookSubscriptionInfo webhookSubscription
        )
        {
        ...
        )
        {
            ...
            if (name.IsNullOrWhiteSpace())
            {
                throw new ArgumentNullException(
                    nameof(name),
                    $"{nameof(name)} can not be null, empty or whitespace!"
                );
            }
        ...
        /// </summary>
        /// <param name="webhookSubscription"></param>
        public static void RemoveAllSubscribedWebhooks(
            this WebhookSubscriptionInfo webhookSubscription
        )
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IDictionary<string, string> GetWebhookHeaders(
            this WebhookSubscriptionInfo webhookSubscription
        )
        {
        ...
        /// Adds webhook subscription to <see cref="WebhookSubscriptionInfo.Webhooks"/> if not exists
        /// </summary>
        public static void AddWebhookHeader(
            this WebhookSubscriptionInfo webhookSubscription,
            string key,
            string value
        )
        {
            if (key.IsNullOrWhiteSpace())
            {
                throw new ArgumentNullException(
                    nameof(key),
                    $"{nameof(key)} can not be null, empty or whitespace!"
                );
            }
        ...
        public static void RemoveWebhookHeader(
            this WebhookSubscriptionInfo webhookSubscription,
            string header
        )
        {
