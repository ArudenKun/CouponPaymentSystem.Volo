...
namespace Abp.Web.Validation
{
    public abstract class ActionInvocationValidatorBase : MethodInvocationValidator
    {
        ...
        {
            base.Initialize(method, GetParameterValues(method));
        }

        protected override bool ShouldValidateUsingValidator(
        ...
        protected override void ValidateMethodParameter(
